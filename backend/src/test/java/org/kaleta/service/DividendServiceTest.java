...
class DividendServiceTest
{
    ...
    void getBy()
    {
        Company company1 = entityCompany(1L, "NVDA", Currency.$);
        Company company2 = entityCompany(2L, "SHELL", Currency.€);
        org.kaleta.model.Company modelCompany1 = modelCompany(1L, "NVDA", Currency.$);
        org.kaleta.model.Company modelCompany2 = modelCompany(2L, "SHELL", Currency.€);

        Dividend dividend1 = dividend(1L, company1, "2024-02-10", "100", "15");
        Dividend dividend2 = dividend(2L, company2, "2024-01-01", "50", "5");
        Dividend dividend3 = dividend(3L, company1, "2023-12-31", "80", "8");
        ...
        assertThat(dividends.getDividends().get(0).getId(), is(1L));
        ...
        assertThat(dividends.getDividends().get(1).getId(), is(2L));
        ...
        assertThat(dividends.getDividends().get(2).getId(), is(3L));
    ...
    void getByCompany()
    {
        ...
        assertThat(byCompany.get(modelCompany1).get(1).getId(), is(3L));
        assertThat(byCompany.get(modelCompany2).size(), is(1));
        assertThat(byCompany.get(modelCompany2).get(0).getId(), is(2L));
    }

    @Test
    void getByPeriod()
    {
        Company company = entityCompany(1L, "NVDA", Currency.$);
        org.kaleta.model.Company modelCompany = modelCompany(1L, "NVDA", Currency.$);

        Dividend dividend1 = dividend(1L, company, "2024-02-10", "100", "15");
        Dividend dividend2 = dividend(2L, company, "2024-04-05", "80", "8");
        ...
        assertThat(byPeriod.get("2024-04").get(0).getId(), is(2L));
        assertThat(byPeriod.get("2024-02").size(), is(1));
        assertThat(byPeriod.get("2024-02").get(0).getId(), is(1L));
    ...
    void getYears()
    {
        Company company = entityCompany(1L, "NVDA", Currency.$);
        Dividend dividend1 = dividend(1L, company, "2024-02-10", "100", "15");
        Dividend dividend2 = dividend(2L, company, "2023-04-05", "80", "8");
        Dividend dividend3 = dividend(3L, company, "2024-06-01", "90", "9");
    ...
    {
        Company company = entityCompany(1L, "NVDA", Currency.$);
        Dividend stored = dividend(10L, company, "2024-02-10", "100", "15");
        ...
        when(dividendDao.get(10L)).thenReturn(stored);
    ...
    private static Company entityCompany(Long id, String ticker, Currency currency)
    {
    ...
    private static org.kaleta.model.Company modelCompany(Long id, String ticker, Currency currency)
    {
    ...
    private static Dividend dividend(Long id, Company company, String date, String dividend, String tax)
    {
