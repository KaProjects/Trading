...
INSERT INTO Period (id, companyId, name, ending_month, research) VALUES (2616, 2212, '26Q3', '2609', '[{"type":"bulleted-list","children":[{"type":"list-item","children":[{"text":"EPYC server share continues to climb against Intel Xeon in cloud and enterprise workloads."}]},{"type":"list-item","children":[{"text":"MI300X and MI325X shipments are ramping as hyperscalers diversify AI accelerator supply."}]},{"type":"list-item","children":[{"text":"Client segment benefits from the Ryzen AI PC refresh cycle heading into next fiscal year."}]},{"type":"list-item","children":[{"text":"Gross margin trend remains the key signal for the datacenter mix shift toward accelerators."}]},{"type":"list-item","children":[{"text":"ROCm software maturity still lags CUDA, limiting broader AI developer adoption."}]},{"type":"list-item","children":[{"text":"The TSMC foundry relationship on leading-edge nodes remains a structural advantage over Intel."}]},{"type":"list-item","children":[{"text":"Gaming segment revenue stays soft as the console cycle matures without a new refresh catalyst."}]},{"type":"list-item","children":[{"text":"Embedded segment normalization appears largely complete after a multi-quarter inventory correction."}]},{"type":"list-item","children":[{"text":"Networking and DPU roadmap (Pensando) could open a new growth vector into 2027."}]},{"type":"list-item","children":[{"text":"Capital allocation remains buyback-heavy with limited dividend signal versus large-cap peers."}]},{"type":"list-item","children":[{"text":"Customer concentration risk exists around a handful of hyperscaler AI accelerator orders."}]},{"type":"list-item","children":[{"text":"Competitive response from the next-generation Rubin platform is the primary swing factor."}]},{"type":"list-item","children":[{"text":"Data-center GPU TAM assumptions remain the most sensitive input to the long-term valuation case."}]},{"type":"list-item","children":[{"text":"Operating expense growth needs to trail revenue growth for margin expansion to continue."}]},{"type":"list-item","children":[{"text":"Export-control policy changes remain a recurring tail risk for China-related AI chip revenue."}]}]}]');
